                        ...
                        <div class="col-lg-5">
                            <div class="widget">
                                ...
                                <p class="mb-5">Built with love by Jamil & Mohammad<br> All rights reserved.
                                    Copyright © 2021. MJ.</p>
                                <a href="cart.html" class="btn btn-inverted" target="_blank">Cart</a>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="row">
...
<script src="<?php echo get_template_directory_uri();?>/assets/js/plugin.js"></script>
<script src="<?php echo get_template_directory_uri();?>/assets/js/function.js"></script>
<script src="<?php echo get_template_directory_uri();?>/assets/js/script.js"></script>
<script src="<?php echo get_template_directory_uri();?>/assets/js/our.js"></script>
